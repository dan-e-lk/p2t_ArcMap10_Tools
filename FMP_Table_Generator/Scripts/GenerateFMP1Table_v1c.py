...
sample = open(os.path.join(os.path.split(inspect.getfile(inspect.currentframe()))[0],'fmptable1_sample.html'))
htmlstring = ''
for line in sample:
    htmlstring += line
sample.close()
...
'IslCroMan':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" = '1' AND ("MGMTCON1" = 'ISLD' """ + MGMTCON23isISLD + ')'],
'IslCroOth':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" in('5','7') AND ("MGMTCON1" = 'ISLD' """ + MGMTCON23isISLD + ')'],
'IslPatCro':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" = '2' AND ("MGMTCON1" = 'ISLD' """ + MGMTCON23isISLD + ')'],
'IslOthNon':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" in('3','4','6','8','9','0') AND ("MGMTCON1" = 'ISLD' """ + MGMTCON23isISLD + ')'],
'IslTot':       [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND ("MGMTCON1" = 'ISLD' """ + MGMTCON23isISLD + ')'],

'SPTCroMan':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" = '1' """],
'SPTCroOth':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" in('5','7') """],
'SPTPatCro':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" = '2' """],
'SPTOthNon':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' AND "OWNER" in('3','4','6','8','9','0') """],
'SPTTot':       [""" "POLYTYPE" = 'FOR' AND "FORMOD" = 'PF' """],

'RecCroMan':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('DEPHARV','DEPNAT','LASTCUT','SEEDTREE') AND "OWNER" = '1' """],  ## Added Lastcut and Seedtree Nov 1 ,2018
'RecCroOth':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('DEPHARV','DEPNAT','LASTCUT','SEEDTREE') AND "OWNER" in('5','7') """],
'RecPatCro':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('DEPHARV','DEPNAT','LASTCUT','SEEDTREE') AND "OWNER" = '2' """],
'RecOthNon':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('DEPHARV','DEPNAT','LASTCUT','SEEDTREE') AND "OWNER" in('3','4','6','8','9','0') """],
'RecTot':       [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('DEPHARV','DEPNAT','LASTCUT','SEEDTREE') """],

'BelCroMan':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT') AND "OWNER" = '1' """], ## Deleted Lastcut and Seedtree Nov 1 ,2018
'BelCroOth':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT') AND "OWNER" in('5','7') """],
'BelPatCro':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT') AND "OWNER" = '2' """],
'BelOthNon':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT') AND "OWNER" in('3','4','6','8','9','0') """],
'BelTot':       [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" in('LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT') """],

'ForCroMan':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" not in('DEPHARV','DEPNAT','LASTCUT','LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT','SEEDTREE') AND "OWNER" = '1' """], ## Deleted Last Cut Nov 23
'ForCroOth':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" not in('DEPHARV','DEPNAT','LASTCUT','LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT','SEEDTREE') AND "OWNER" in('5','7') """],
'ForPatCro':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" not in('DEPHARV','DEPNAT','LASTCUT','LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT','SEEDTREE') AND "OWNER" = '2' """],
'ForOthNon':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" not in('DEPHARV','DEPNAT','LASTCUT','LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT','SEEDTREE') AND "OWNER" in('3','4','6','8','9','0') """],
'ForTot':       [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "DEVSTAGE" not in('DEPHARV','DEPNAT','LASTCUT','LOWMGMT', 'LOWNAT','NEWPLANT','NEWSEED','NEWNAT','SEEDTREE') """],

'SPDCroMan':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "OWNER" = '1' """],
'SPDCroOth':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "OWNER" in('5','7') """],
'SPDPatCro':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "OWNER" = '2' """],
'SPDOthNon':    [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') AND "OWNER" in('3','4','6','8','9','0') """],
'SPDTot':       [""" "POLYTYPE" = 'FOR' AND "FORMOD" in('RP','MR') """],
