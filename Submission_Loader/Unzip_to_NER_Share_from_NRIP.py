...
def main(NRIP_Downloadzipfile,outputFMPfolder,openfolder):
	"""
	NRIP_Downloadzipfile is the file location of the zipfile downloaded off the NRIP (can be a zipfile or a non-zipfile)
	...
	print2('NRIP_Downloadzipfile = %s'%NRIP_Downloadzipfile)
	...
	print2('Unzipping...')
	submFolderDirList = UnzipAll.unzipAllSubmission(NRIP_Downloadzipfile)
...
if __name__ == '__main__':
	...
	# NRIP_Downloadzipfile = r'C:\FIPDownload\download_cart_2018-10-30ar.zip'
	...
	# main(NRIP_Downloadzipfile,outputFMPfolder)



	NRIP_Downloadzipfile = arcpy.GetParameterAsText(0) # must be an existing zipfile
	...
	main(NRIP_Downloadzipfile,outputFMPfolder,openfolder)