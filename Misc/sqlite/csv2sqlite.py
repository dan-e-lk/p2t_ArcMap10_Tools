# This is a stand-alone script that can be used directly to turn any csv file to a table in sqlite.
...
def csv_to_sqlite(csvfile, database_name, table_name):
	"""
	turns your csvfile into a new table in a new or existing sqlite database.
