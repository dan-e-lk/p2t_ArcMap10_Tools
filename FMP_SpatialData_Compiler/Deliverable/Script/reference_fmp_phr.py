# This script contains information specific to FMP_PHR data.
...
fieldname_update = {
	...
	'BLOCKID':		['BLOCK_ID','BLK_ID', 'BLOCK'], # an error might occur if one layer has both BLOCK_ID and BLK_ID because it will try to alter both fieldnames to BLOCKID.
